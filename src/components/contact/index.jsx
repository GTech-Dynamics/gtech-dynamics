    ...
    return ( 
      <Box className="contact-parent">
        <Box className="contact-child1">
            ...
            <Typography variant="h6" className='contact-styled-heading'>CONTACT US</Typography> 
            <Typography variant='h2' sx={{marginTop: '30px'}}>Get In Touch With Us</Typography>
            <Typography>Gtech Dynamics designs tailor-made software solutions and services for businesses in all domains.
