  ...
  return (
    <Box className="technology-menu">
      ...
      >
        ...
        <Tab label="Mobile App Developmetn" {...a11yProps(2)} />
      ...
      <TabPanel value={value} index={0} className="technology-tabpanel">
        ...
        <Typography variant="p">
          ...
          trends, innovative design, graphics, usability, and creativity. Today,
          front-end development is the most sought-after skill. We use HTML,
          CSS, JavaScript, React, and Vue.
        </Typography>
      </TabPanel>
      ...
      <TabPanel value={value} index={2} className="technology-tabpanel">
        ...
        <Typography variant="p">
          ...
          which cover everything from application design to management services.
          Software experts at Code Graphers are capable and experienced in
          developing a customized mobile app for your niche, whether it is a
          customer-oriented or enterprise-class solution.
        </Typography>
      </TabPanel>
      <TabPanel value={value} index={3} className="technology-tabpanel">
        ...
        <Typography variant="p">
          ...
          will help you proactively administer and manage the platforms through
          which you share media, information, and data. Management of systems,
          applications, IoT, user devices, and resilience are also covered in
          our services.
        </Typography>
      </TabPanel>
      <TabPanel value={value} index={4} className="technology-tabpanel">
        <Typography variant="h3">Hybrid App </Typography>
        <Typography variant="p">
          We have a team of highly qualified and experienced hybrid app
          developers. Using cutting-edge technology and our expertise in mobile
          web development, we can deliver a product that will meet market needs
          in terms of UX and UI design.
        </Typography>
      </TabPanel>
      <TabPanel value={value} index={5} className="technology-tabpanel">
        <Typography variant="h3">Microservices </Typography>
        <Typography variant="p">
          Developers at Code Graphers are skilled in deriving solutions
          according to your demands. Our microservices help develop a collection
          of independent applications instead of a monolithic app. We can help
          structure big and complicated apps with simple programs that can
          execute themselves.
        </Typography>
      </TabPanel>
    </Box>
